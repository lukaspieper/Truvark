 ...
 */
@HiltWorker
public class DatabaseSyncingWorker @AssistedInject constructor(
     ...
     */
    public class EmptyWorkBundle : WorkBundle(size = 1) {
        override val progress: MutableStateFlow<Int> = MutableStateFlow(0)
