 ...
 */
public class BiometricCryptoProvider(context: Context) {
    ...
    public fun createEncryptingPromptObject(): BiometricPrompt.CryptoObject {
    ...
    @Throws(Exception::class)
    public fun createDecryptingPromptObject(iv: ByteArray): BiometricPrompt.CryptoObject {
