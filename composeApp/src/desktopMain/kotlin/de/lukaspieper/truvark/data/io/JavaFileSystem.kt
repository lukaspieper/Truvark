...
public class JavaFileSystem : FileSystem() {
    ...
    override fun listFiles(directoryInfo: DirectoryInfo): Flow<FileInfo> {
    ...
    override fun listDirectories(directoryInfo: DirectoryInfo): Flow<DirectoryInfo> {
        return (directoryInfo.uri as File).listFiles()
            .orEmpty()
            .asFlow()
            .filter { it.isDirectory }
            .map { directoryInfo(it) }
    }
